...
<q-card class="card-payment q-mb-md" flat bordered >
  ...
  <div  class="q-pb-md" >
    <q-item class="payment-list-border" />
<q-list
    transition="flip-right"
    class="card-payment payment-list-main"
...
/>
  ...
  >
    ...
    <q-item  @click="payment.expand=!payment.expand"  clickable v-ripple >
    <q-badge color="primary" v-if="payment.doctor!==''" class="absolute-top-right badge-doctor">{{DoctorFilter(payment.doctor)}}</q-badge>
    <q-item-section avatar>
      <q-circular-progress
  show-value
...
>
    ...
    <q-item-section >
      <div class="text-weight-bold"> {{payment.tooth}} : {{payment.details}}</div>
    <div class="row" v-if="$q.screen.gt.xs">
    <div class="text-caption text-grey">Last Update: {{(dateFormatted(payment.updated))}}</div>
    <div class="col row position-right"></div>
            <div class="row q-pl-xs">
  ...
  <div   v-else>
    <div class="row" >
    <div class="text-caption text-grey"> Updated : {{(dateFormatted(payment.updated))}}</div>
    <div class="row q-pl-xs">
          ...
          <q-item-section  side>  <q-btn v-on:click.stop :class="{'' :$q.screen.gt.xs , 'absolute' :!$q.screen.gt.xs}" size="12px" flat dense round icon="add" /></q-item-section>
